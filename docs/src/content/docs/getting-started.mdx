...
description: Install crackdown and lint your first Markdown file in under 60 seconds.
---
...
- Read the [CLI Reference](/crackdown/cli-reference/) for all commands and flags.
- Learn how to [write your own plugin](/crackdown/plugin-guide/).
- Migrating from markdownlint? See the [Migration Guide](/crackdown/migration/).
